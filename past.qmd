...
title: "Past"
---
LANDFIRE's Biophysical Settings (BpSs, aka "Historical Ecosystems") represent 

"_...the vegetation system that may have been dominant on the landscape prior to Euro-American settlement. BpS models are based on both the current biophysical environment and an approximation of the historical disturbance regime_." - [Read more](https://landfire.gov/bps.php){target="blank"}.
...
* Prior to European colonization, the most dominant vegetation system for this region was once [Inter-Mountain Basins Big Sagebrush Shrubland-Wyoming Big Sagebrush](https://landfirereview.org/search.php?q=Inter-Mountain%20Basins%20Big%20Sagebrush%20Shrubland-Wyoming%20Big%20Sagebrush&hPP=20&idx=lf_landfire_dev&p=0&is_v=1){target="blank"}. This system also burned on average 4x more than the next most common ecosystem (Inter-Mountain Basins Montane Sagebrush Steppe)
* Within this subregion, the most prevalent LANDFIRE Mean Fire Return Interval (from BpS) was 76-100 years
