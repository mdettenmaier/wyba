...
>"_...the vegetation system that may have been dominant on the landscape prior to Euro-American settlement. BpS models are based on both the current biophysical environment and an approximation of the historical disturbance regime_." 
>
> --- [Read more](https://landfire.gov/bps.php){target="blank"}.
