...
* Shrub cover is dominant in this subregion with most shrub height(s) concentrated between .5 m and .9 m.
...
From these results, we can see the majority of vegetation on the landscape is .25-.9 meters high.
