...
The data from chart below is displayed spatially on the map (directly) below the chart. The colors on the graph correspond to the EVC classifications on the landscape.  
...
## Existing Vegetation Cover
The map below is a visual, spatial representation of the information on the chart above. For example, the majority of this subregion is classified as "shrub," which aligns with the information conveyed on the chart (above) where shrub cover comprises approximately 80% of the vegetation in this subregion.
