...
* EVT layer represents the current distribution of the terrestrial ecological systems classification, developed by NatureServe for the western hemisphere, through 2016
* EVC layer represents the vertically projected percent cover of the live canopy layer for a 30-m cell
* EVH layer represents the average height of the dominant vegetation for a 30-m cell
...
evcChart <-
  ...
  annotation_custom(evc_map, xmax = 0.5, ymax = 0.5)


evcChart

evc_map <- readPNG("images/evc.png", native = TRUE)

evc_chart_map <- evcChart +
  inset_element(p = evc_map,
                left = 0.6,
                bottom = 0.01,
                right = 0.98,
                top = 0.5
